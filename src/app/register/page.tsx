...
export default function RegisterPage() {
  return (
    <>
      ...
      <main className="bg-gray-200 w-full min-h-screen flex items-center justify-center">
        <div className="lg:flex items-center space-x-16">
          <div className="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
            ...
            <p className="text-center text-sm text-gray-600 mt-2">
              ...
              <Link href={'/login'} className='text-red-400 hover:text-red-600'>Sign in here</Link>
            </p>
